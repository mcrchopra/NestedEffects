...
def run_PEER(gene_expression_file, num_confounders,covariates_1,covariates_2,covariates_3):
	...
	corrected_data.to_csv(path_or_buf = "peer_three_covariate_results.tab",sep = '\t')
